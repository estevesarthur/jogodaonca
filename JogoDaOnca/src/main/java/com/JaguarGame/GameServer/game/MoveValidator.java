...
import com.JaguarGame.Common.Key;
...
public class MoveValidator {
  ...
  private MoveValidator() {
    ...
    moves.put(new Key(2, 0),
        EnumSet.of(Direction.Left, Direction.UpLeft, Direction.Up, Direction.UpRight, Direction.Right));
    ...
    moves.put(new Key(2, 4),
        EnumSet.of(Direction.Right, Direction.DownRight, Direction.Down, Direction.DownLeft, Direction.Left));
