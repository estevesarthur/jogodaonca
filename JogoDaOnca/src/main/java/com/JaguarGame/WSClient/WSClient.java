/* package com.JaguarGame.WSClient;
...
public class WSClient {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
      ...
      private static void executaTeste(String rad) throws IOException, InterruptedException {
      ...
      private static int ehMinhaVez(int playerId) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
        return port.ehMinhaVez(playerId);
      }
    
      private static int encerraPartida(int playerId) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
        return port.encerraPartida(playerId);
      }
    
      private static int enviaJogadaCao(int playerId, int dogId, int direction) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
        return port.enviaJogadaCao(playerId, dogId, direction);
      }
    
      private static int enviaJogadaOnca(int playerId, int direction) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
        return port.enviaJogadaOnca(playerId, direction);
      }
    
      private static String obtemGrade(int playerId) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
        return port.obtemGrade(playerId);
      }
    
      private static String obtemOponente(int playerId) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
      ...
      private static int registraJogador(java.lang.String playerName) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
        return port.registraJogador(playerName);
      }
    
      private static int temPartida(int playerId) throws InterruptedException {
        WS service = new WS();
        WS port = service.getJaguarWSPort();
