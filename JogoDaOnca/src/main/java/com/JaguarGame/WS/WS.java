/* package com.JaguarGame.WS;

import com.JaguarGame.Common.Direction;
import com.JaguarGame.GameServer.server.Game;
...
public class WS {
    ...
    public int preRegistro(@WebParam(name = "playerName1") final String playerName1,
            @WebParam(name = "playerId1") final int playerId1, @WebParam(name = "playerName2") final String playerName2,
            @WebParam(name = "playerId2") final int playerId2) {
    ...
    public int enviaJogadaOnca(@WebParam(name = "playerId") final int playerId,
            @WebParam(name = "direction") final int direction) throws InterruptedException {
    ...
    public int enviaJogadaCao(@WebParam(name = "playerId") final int playerId,
            @WebParam(name = "dogId") final int dogId, @WebParam(name = "direction") final int direction)
